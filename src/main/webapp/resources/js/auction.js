...
$(document).ready(function(){
   ...
   function updateRealTimeList1(data) {
      ...
      for (var i=0; i<5; i++) {
         ...
         if (arrLoc.length > 1) {
            html += "<td style = 'width : 250px; height : 37px; table-layout:fixed;'>" + arrLoc[0] +" 외 "+ locCnt +" 곳</td>";
         } else {
            html += "<td style = 'width : 250px; height : 37px; table-layout:fixed;'>" + arrLoc[0] + "</td>";
         }
         
         
         html += "<td style = 'width : 150px; height : 37px; table-layout:fixed;'>" + data[i].deadline + "</td>";
      ...
      setInterval(function(){
         ...
         $('#realtimelist > tbody:first > tr:first').animateCss('fadeOutUp', function() {
            ...
            var appendTag  = "<tr class='" + arr[classIndex] + "' style='position: relative;'>";
             ...
             appendTag += "<td style = 'width : 250px; height : 37px; table-layout:fixed;'>" + arrLoc[0] +" 외 2 곳</td>";
             appendTag += "<td style = 'width : 150px; height : 37px; table-layout:fixed;'>" + data[index].deadline + "</td>";
