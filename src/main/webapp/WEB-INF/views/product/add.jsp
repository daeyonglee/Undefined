    ...
    <div class="row">
      <div class="col-sm-10 col-sm-offset-1 profiel-container">
        ...
        <div class="clear">
          ...
          <div class="form-group">
            <label> 가게 이름 </label> <input name="Password"
              type="text" class="form-control" placeholder="가게이름"
              disabled>
          </div>
          <div class="form-group">
            <label> 가격</label> <input name="Password"
              type="text" class="form-control" placeholder="1,000,000(원)">
          </div>
        </div>
