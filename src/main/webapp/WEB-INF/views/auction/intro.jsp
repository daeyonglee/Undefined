   ...
   <div class="testimonial-area recent-property"
      ...
      <div class="client-text">
         ...
         <p>*웨딩 역경매 신청은 무료이며, 어떠한 경우에도 별도 비용이 발생하지 않습니다.</p>
                <div class="row">
        <div class="row testimonial client-text">
          <div class="col-md-12">
          ...
          <span id=button> 
            <input type='button' class='btn-primary' id="studioRegistBtn" name='submit' value='스튜디오 역경매 신청하기' style="width: 250px"/>
            <input type='button' class='btn-primary' id="dressRegistBtn" name='cancel' value='드레스 역경매 신청하기' style="width: 250px" />
            <input type='button' class='btn-primary' id="makeupRegistBtn" name='cancel' value='메이크업 역경매 신청하기' style="width: 250px" />
          </span></div>
      </div>
