                         ...
                         <div class="col-lg-2">
                          ...
                          <div  class="col-lg-10">
                           <div class="checkbox">
                            ...
                            <label> <input type="radio" name="type" value="company" checked="checked" /> <strong>드레스</strong></label> 
                            <label> <input type="radio" name="type" value="company" /> <strong>메이크업</strong></label>
                          </div></div>
                         </div>
