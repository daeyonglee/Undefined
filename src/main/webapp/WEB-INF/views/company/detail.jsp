...
<%@ include file="../include/top.jsp"%>
    ...
    <img src="/resources/assets/img/slide1/slider-image-1.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="/resources/assets/img/slide1/slider-image-1.jpg" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="/resources/assets/img/slide1/slider-image-1.jpg" style="width:100%" onclick="currentSlide(2)" alt="Trolltunga, Norway">
    </div>
    <div class="column">
                            ...
                            <div class="light-slide-item">            
                                <div class="clearfix">
                                    ...
                                    <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                        ...
                                        <li data-thumb="/resources/img/property-1/property2.jpg"> 
