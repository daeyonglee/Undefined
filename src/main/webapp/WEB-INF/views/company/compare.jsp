...
<script>
  ...
  function show(point) {
    ...
    for (i=1; i<=point; i++) {
      ...
      el.src = "/resources/images/full22.png";
    }
  ...
  function noshow(point) {
    ...
    for (i=1; i<=point; i++) {
      image = 'image' + i;
      el = document.getElementById(image);
      el.src = "/resources/images/empty22.png";
    }
  }
                  ...
                  <tr>
                    <td>
                        <div id="rating">
                          ...
                          <img id=image1 onmouseover=show(1) onclick=mark(1) onmouseout=noshow(1) src="/resources/images/empty22.png"> 
                          <img id=image2 onmouseover=show(2) onclick=mark(2) onmouseout=noshow(2) src="/resources/images/empty22.png">
                          <img id=image3 onmouseover=show(3) onclick=mark(3) onmouseout=noshow(3) src="/resources/images/empty22.png"> 
                          <img id=image4 onmouseover=show(4) onclick=mark(4) onmouseout=noshow(4) src="/resources/images/empty22.png"> 
                          <img id=image5 onmouseover=show(5) onclick=mark(5) onmouseout=noshow(5) src="/resources/images/empty22.png"> 
                        
                        </div>
                        <input type="hidden" name="point"/>  
                    </td>
                    <td colspan="2"><span id="startext">평가하기</span></td>
                  </tr>
                  <tr>
                    <td><textarea name="content" placeholder="이곳에 후기를 남겨주세요.." style="max-width: 70%"></textarea></td>
                  ...
                  <tbody>
                    <c:forEach items="${list}" var="studioReview">
                      <tr>
                        ...
                        <td><span class="star-prototype">${studioReview.point}</span></td>
...
$(document).ready(readyFn);
                  ...
                  <div class="clear">
                    ...
                    <p style="color: black">${studioCompany.introduce}</p>
                      ...
                      <input type='hidden' name='addr' value="${studioCompany.addr}">
                     ...
                     <c:when test="${not empty cart}">
                       <c:if test="${not flag}">
                         <c:forEach items="${cart}" var="dto">
                          <c:if test="${comp eq dto.companyNo}">
...
<script type="text/javascript">
        ...
        geocoder.geocode( { 'address': address}, function(results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                marker = new google.maps.Marker({
                                ...
                                title: '${studioCompany.nm}', // 마커에 마우스 포인트를 갖다댔을 때 뜨는 타이틀
                                position: results[0].geometry.location
                            });
 
                var content = "<b>${studioCompany.nm}</b><br/><br/>Tel: ${studioCompany.tel}"; // 말풍선 안에 들어갈 내용
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel" style="text-align: center">비교하기</h4>
        </div>
  ...
  <c:forEach items="${cart}" var="studioCompany">      
  <tr>
    <td><img src="/resources/assets/img/property-1/property1.jpg" id="imgBorder" class="img-responsive" width="70%" alt=""></td>
    <td>${studioCompany.nm}</td>
    <td>${studioCompany.addr}</td>
    <td>${avg}</td>
  </tr>
  </c:forEach>
