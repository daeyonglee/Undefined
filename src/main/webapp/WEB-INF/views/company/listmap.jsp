        ...
        <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                    ...
                    <div class="item"><img src="/resources/assets/img/slide1/slider-image-1.jpg"></div>
                    <div class="item"><img src="/resources/assets/img/slide1/slider-image-2.jpg"></div>
                    <div class="item"><img src="/resources/assets/img/slide1/slider-image-3.jpg"></div>
                    <div class="item"><img src="/resources/assets/img/slide1/slider-image-4.jpg"></div>
            ...
            <div class="slider-content">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
													<div class="search-form wow pulse slider-content-left">
														<form action="">
															<div class="col-sm-12">
																<h3>총 예산으로 스드메를 한번에</h3>
																<label style="color: gray;">위치와 조합을 입력하여 예산을 확인하세요.</label>
                            ...
                            <div id="testimonial-slider">
                                <div class="item">
                                    ...
                                    <div class="client-face wow fadeInRight" data-wow-delay=".9s"> 
                                        <img src="/resources/assets/img/client-face1.png" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="client-text">                                
                                    ...
                                    <div class="client-face">
                                        <img src="/resources/assets/img/client-face2.png" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="client-text">                                
