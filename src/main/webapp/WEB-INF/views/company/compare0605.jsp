                ...
                <div class="inner-wrapper">
                  ...
                  <div class="clear">
                    ...
                    <form method="post" action="/company/add">
                      <input type='hidden' name='companyNo'
                        value="${studioCompany.companyNo}"> <input
                        type='hidden' name='nm'
                        value="${studioCompany.nm}"> <input
                        type='submit' class='btn btn-next btn-primary'
                        name='next' value='비교업체 등록' />
                    </form>
...
<!-- 지도시작 -->
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <c:forEach items="${cart}" var="studioCompany">
      ...
      <p>${studioCompany.nm}</p>
      <p>${studioCompany.companyNo}</p>
    </c:forEach>
    <img src="/resources/assets/img/property-1/property1.jpg"
      class="img-responsive" width="100%" alt=""> <img
      src="/resources/assets/img/property-1/property1.jpg"
      class="img-responsive" width="100%" alt="">
  ...
  <p>
    <span id="floatdiv" class="glyphicon glyphicon-chevron-left"
      style="font-size: 30px; cursor: pointer; left: 1480px"
