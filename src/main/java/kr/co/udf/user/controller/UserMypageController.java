...
public class UserMypageController {
	...
	@Inject
	private AuctionApplyService applyService;
	...
	public String my(@RequestParam("pw") String pw, HttpSession session, Model model)
			...
			if (pw.equals(login.getPw())) {
				...
				if ("users".equals(login.getRole())) {
					...
					if (company.getMainImg() != null) {
						/*
						 * String fileName = company.getMainImg(); String formatName =
						 * fileName.substring(fileName.lastIndexOf(".")+1); MediaType mType =
