...
public class MakeupCompany {
   ...
   public MakeupCompany(int companyNo, String nm, int regNo, String headName, String addr, String mainImage,
   ...
   public String toString() {
      return "MakeupCompany [companyNo=" + companyNo + ", nm=" + nm + ", regNo=" + regNo + ", headName=" + headName
